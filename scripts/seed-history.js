...
async function main() {
  ...
  try {
    ...
    const data = Array.from({ length: 10 }).map((_, i) => {
      ...
      const lats = [
        31.2304, 22.5431, 39.9042, 30.26, 32.0603, 29.563, 23.1291, 34.3416, 36.0611, 26.647
      ]
      const lons = [
        121.4737, 114.0579, 116.4074, 120.19, 118.7969, 106.551, 113.2644, 108.9398, 103.8343,
        106.653
      ]
