...
export const FISH_STATUS_CONFIG: FishStatusMapping[] = [
  ...
  { keyword: 'FORWARD', status: 'forward', label: '正在向前' },
  { keyword: 'LEFT', status: 'left', label: '正在向左' },
  { keyword: 'RIGHT', status: 'right', label: '正在向右' },
  { keyword: 'UP', status: 'up', label: '正在向上' },
  { keyword: 'DOWN', status: 'down', label: '正在向下' },
  { keyword: 'SURF', status: 'surf', label: '正在上浮' },
  { keyword: 'MAN', status: 'manual', label: '人工模式' },
  { keyword: 'RETURN', status: 'return', label: '正在返航' },
