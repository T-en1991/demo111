<template>
    <div class="jsmpeg-player-wrapper">
        <div ref="videoContainer" class="jsmpeg-player" style="width: 100%; height: 480px; background: #000;"></div>
        <div class="jsmpeg-controls">
            ...
            <div class="progress-volume-row">
                ...
                <input type="range" min="0" :max="duration" step="0.01" v-model="progress" @input="onSeek"
                    style="width:180px;" />
                <span style="margin-left:8px;">{{ formatTime(progress) }} / {{ formatTime(duration) }}</span>
